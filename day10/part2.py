...
targets = [[1 if n == 9 else 0 for x, n in enumerate(l)] for y, l in enumerate(lines)]
...
print(sum(c for y, row in enumerate(targets) for x, c in enumerate(row) if lines[y][x] == 0))
